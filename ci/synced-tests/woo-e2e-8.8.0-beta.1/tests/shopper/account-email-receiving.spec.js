...
test.describe( 'Shopper Account Email Receiving', () => {
	...
	test.skip( 'should receive an email when creating an account', async ( {
		page,
	} ) => {
	...
	test.skip( 'should receive an email when password reset initiated from admin', async ( {
		page,
	} ) => {
		// create a new customer
		await page.goto( 'wp-admin/user-new.php' );
...
test.describe( 'Shopper Password Reset Email Receiving', () => {
	...
	test.skip( 'should receive an email when initiating a password reset', async ( {
		page,
	} ) => {
